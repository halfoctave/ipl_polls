...
def combine_csv_files(input_dir):
    ...
    result_dir = os.path.abspath(os.path.join(base_dir, "../results/weekly/poll_winner"))
...
if __name__ == "__main__":
    base_dir = os.path.dirname(__file__)
    input_dir = os.path.abspath(os.path.join(base_dir, "../data/processed", WEEK, "poll_winner"))
