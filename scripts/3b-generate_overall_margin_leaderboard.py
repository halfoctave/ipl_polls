...
def generate_leaderboard():
    """
    Generate an overall leaderboard CSV from weekly margin poll CSVs up to the specified week,
    ...
    output_dir = os.path.abspath(os.path.join(base_dir, "../results/overall/poll_margin"))
    ranks_dir = os.path.abspath(os.path.join(base_dir, "../results/ranks/poll_margin"))
    ...
    print(f"Overall margin leaderboard created: {output_file}")
...
if __name__ == "__main__":
    ...
    if output_file:
        print(f"Overall margin leaderboard generation completed for {WEEK}")